...
This includes a class `Func_prop` to specify the considered functional 
properties of breast tissues and lesion. The considered functional 
properties include oxygen saturation `s` (%) and volume fractions of blood
`f_b`, water `f_w`, fat `f_f`, and melanosome `f_m` (%).
...
class Func_prop:
  ...
  f_m = {
    ...
    'fat':        0.,
    'dermis':     0.,
    'epidermis':  0.305,    # skin color 5,
    # 'epidermis':  0.23825,  # skin color 4, 
    # 'epidermis':  0.1715,   # skin color 3, 
    # 'epidermis':  0.10475,  # skin color 2, 
    # 'epidermis':  0.038,    # skin color 1 
    # 'skin':       {'mean': 0.0064, 'std': 0.0004, 'min': 0.0044, 'max': 0.0084}, # skin I-II
    'glandular':  0.,
    'nipple':     {'mean': 0.0082, 'std': 0.0009, 'min': 0.004, 'max': 0.0124}, # skin III-IV
    'ligament':   0.,
    'tdlu':       0.,
    'duct':       0.,
    'artery':     0.,
